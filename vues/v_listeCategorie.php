<div class="container mt-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="index.php?uc=categories&action=ajouterCategorie" class="btn btn-success">
                    ...
                    <td class="text-center align-middle">
                        <div class="btn-group" role="group">
                            ...
                            <a class="btn btn-outline-warning btn-sm"
                                href="index.php?uc=categories&action=modifierCategorie&id=<?= $idCategorie ?>"
                                title="Modifier">
                                <i class="bi bi-pencil"></i>
                            </a>
                            <a class="btn btn-outline-danger btn-sm"
                                href="index.php?uc=categories&action=supprimerCategorie&id=<?= $idCategorie ?>"
