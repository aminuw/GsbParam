        ...
        <div class="align-self-center collapse navbar-collapse justify-content-end align-items-center" id="navbar-toggler-success">
          <div class="d-flex justify-content-center mx-auto mx-xl-0">
            <ul class="nav mb-2 flex-lg-row flex-column d-flex justify-content-center align-items-center mb-md-0">
              ...
              <li><a  href="index.php?uc=voirProduits&action=ajouterProduit" class="nav-link rounded-pill px-3 mx-1 fw-bold link-dark">Ajouter un produit</a></li>
              <li><a  href="index.php?uc=voirProduits&action=listeProduitsModif" class="nav-link rounded-pill px-3 mx-1 fw-bold link-dark">Modifier un produit</a></li>
              ...
              <?php if (isset($_SESSION['client'])): ?>
                <li><span class="nav-link px-3 mx-1 fw-bold">Bonjour, <?php echo htmlspecialchars($_SESSION['client']->prenom); ?></span></li>
                <li><a href="index.php?uc=utilisateur&action=deconnexion" class="nav-link rounded-pill px-3 mx-1 fw-bold link-dark">Déconnexion</a></li>
              <?php else: ?>
                <li><a href="index.php?uc=utilisateur&action=inscription" class="nav-link rounded-pill px-3 mx-1 fw-bold link-dark">S'inscrire</a></li>
                <li><a href="index.php?uc=utilisateur&action=connexion" class="nav-link rounded-pill px-3 mx-1 fw-bold link-dark">Se connecter</a></li>
              <?php endif; ?>
