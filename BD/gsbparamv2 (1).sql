...
INSERT INTO `associer` (`idproduit`, `idproduit_associer`) VALUES
('c01', 'c02'),
('c01', 'c04');
...
('f01', 'Nuxe Men Contour des Yeux Multi-Fonctions', 'Contour des yeux multi-fonctions pour homme.', 12.05, 'assets/images/nuxe-men-contour-des-yeux-multi-fonctions-15ml.png', 30, 5, NULL, NULL, 'FO', 5, 1),
('f02', 'Tisane romon nature sommirel bio sachet 20', 'Tisane Sommirel BIO pour le sommeil.', 5.50, 'assets/images/tisane-romon-nature-sommirel-bio-sachet-20.jpg', 200, 20, NULL, NULL, 'FO', 6, 4),
('f03', 'La Roche Posay Cicaplast crème pansement', 'Crème réparatrice Cicaplast.', 11.00, 'assets/images/la-roche-posay-cicaplast-creme-pansement-40ml.jpg', 150, 15, NULL, NULL, 'FO', 7, 2),
('f04', 'Futuro sport stabilisateur pour cheville', 'Attelle de cheville stabilisatrice.', 26.50, 'assets/images/futuro-sport-stabilisateur-pour-cheville-deluxe-attelle-cheville.png', 20, 2, NULL, NULL, 'FO', 8, 1),
('f05', 'Microlife pèse-personne électronique weegschaal', 'Pèse-personne électronique de haute précision.', 63.00, 'assets/images/microlife-pese-personne-electronique-weegschaal-ws80.jpg', 15, 2, NULL, NULL, 'FO', 9, 1),
('f06', 'Melapi Miel Thym Liquide 500g', 'Miel de thym liquide naturel.', 6.50, 'assets/images/melapi-miel-thym-liquide-500g.jpg', 90, 10, NULL, NULL, 'FO', 10, 1),
('f07', 'Meli Meliflor Pollen 200g', 'Pollen de fleur naturel.', 8.60, 'assets/images/melapi-pollen-250g.jpg', 75, 5, NULL, NULL, 'FO', 11, 1),
('p01', 'Avène solaire Spray très haute protection', 'Spray solaire SPF 50+, protection optimale.', 22.00, 'assets/images/avene-solaire-spray-tres-haute-protection-spf50200ml.png', 140, 15, NULL, NULL, 'PS', 12, 3),
('p02', 'Mustela Solaire Lait très haute Protection', 'Lait solaire SPF 50+ pour bébés et enfants.', 17.50, 'assets/images/mustela-solaire-lait-tres-haute-protection-spf50-100ml.jpg', 100, 10, NULL, NULL, 'PS', 13, 2),
('p03', 'Isdin Eryfotona aAK fluid', 'Fluide protecteur solaire haute technologie.', 29.00, 'assets/images/isdin-eryfotona-aak-fluid-100-50ml.jpg', 45, 5, NULL, NULL, 'PS', 14, 2),
('p04', 'La Roche Posay Anthélios 50+ Brume Visage', 'Brume solaire visage toucher sec.', 8.75, 'assets/images/la-roche-posay-anthelios-50-brume-visage-toucher-sec-75ml.png', 85, 10, NULL, NULL, 'PS', 7, 1),
('p05', 'Nuxe Sun Huile Lactée Capillaire Protectrice', 'Huile lactée protectrice pour les cheveux au soleil.', 15.00, 'assets/images/nuxe-sun-huile-lactee-capillaire-protectrice-100ml.png', 65, 5, NULL, NULL, 'PS', 5, 2),
('p06', 'Uriage Bariésun stick lèvres SPF30 4g', 'Stick lèvres protecteur SPF 30.', 5.65, 'assets/images/uriage-bariesun-stick-levres-spf30-4g.jpg', 180, 20, NULL, NULL, 'PS', 15, 5),
('p07', 'Bioderma Cicabio creme SPF50+ 30ml', 'Crème réparatrice avec protection solaire.', 13.70, 'assets/images/bioderma-cicabio-creme-spf50-30ml.png', 95, 10, NULL, NULL, 'PS', 16, 2);
